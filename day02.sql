...
--SORU 11: Ogrenciler tablosunda sinav_notu 65 ve 85 arasında olan ogrencilerin tüm bilgilerini listele
...
select isim,sinav_notu from ogrenciler where  sinav_notu not between 65 and 90;

-- 2. yol

select isim,sinav_notu from ogrenciler where  sinav_notu<75 or sinav_notu>75;
